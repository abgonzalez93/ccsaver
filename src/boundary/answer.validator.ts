...
const INNER_FENCE = /^```/m
const RISKY =
  /\bchild_process\b|\bprocess\.env\b|\bprocess\[|\bprocess\.exit\b|\bsubprocess\b|\bos\.system\b|\b(?:eval|fetch|Function|import|require)\(|\brm -rf?\b|\b(?:curl|wget) |\b(?:rm|write|append|rename|unlink|rmdir|symlink)(?:File)?Sync\b|\bsendBeacon\b|\bhttp\.request\b|\bnet\.connect\b|\bWebSocket\b/g
