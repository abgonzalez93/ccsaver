...
- The [handoff warning](#the-handoff-warning), on or off and at how many tokens (`handoff:`); a `handoff.json` that is there but cannot be trusted is a `FAIL` with its name.
