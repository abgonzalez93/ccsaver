...
ccsaver sets two of its own: `NODE_COMPILE_CACHE` (the `cache/` folder of the state folder, for the hook and the command) and `MAX_THINKING_TOKENS=0` for the fallback.
